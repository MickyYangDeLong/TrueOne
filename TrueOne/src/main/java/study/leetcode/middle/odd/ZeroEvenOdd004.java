...
public class ZeroEvenOdd004 {
    ...
    public void odd(IntConsumer printNumber) throws InterruptedException {
        ...
        try {
            ...
            while (index <= flag && !Thread.currentThread().isInterrupted()) {
                if (startFlag) {
                    awaitZeroOrOdd.await();
                    if (index > n){
                        break;
    ...
    private static void success(int n) {
        ZeroEvenOdd004 zeroEvenOdd = new ZeroEvenOdd004(n);
