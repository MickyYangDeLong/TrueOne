...
public class TestClassReflect {
    ...
    public static void main(String[] args) {
        try {
            // 创建对象
            TestClassReflect.reflectNewInstance();

            // 反射私有的构造方法
            TestClassReflect.reflectPrivateConstructor();

            // 反射私有属性
            TestClassReflect.reflectPrivateField();

            // 反射私有方法
            TestClassReflect.reflectPrivateMethod();
        } catch (Exception ex) {
            ex.printStackTrace();
        }
    }
